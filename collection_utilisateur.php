...
<html lang="en">
  ...
  if(isset($_SESSION['user'])){
    ...
    if (isset($_POST['id_collection'])) {
      $_SESSION['id_collection'] = $_POST['id_collection'];
  }
  if (isset($_POST['name_collection'])) {
      $_SESSION['name_collection'] = $_POST['name_collection'];
  }
  if (isset($_SESSION['id_collection'])) {
    $id_collection = $_SESSION['id_collection'];
}
if (isset($_SESSION['name_collection'])) {
    $name_collection = $_SESSION['name_collection'];
}

    ///echo '<h1 class="custom-h1">Collection de ' . $name_collection . '<h1>';
  ...
  if(isset($_SESSION['id_collection'])) {
      $id_collection = $conn->real_escape_string($_SESSION['id_collection']);
    ...
    <div class="header__wrapper">
      ...
      <div class="cols__container">
        <div class="left__col">
          ...
          <?php echo '<h2>Collection de ' . $name_collection . '<h2>'; ?>
