...
<body id="top">
    ...
    $id_session = $data['id'];
    $sql = "SELECT abonnement.id_collection, utilisateurs.pseudo FROM abonnement INNER JOIN utilisateurs ON abonnement.id_collection = utilisateurs.id
    WHERE abonnement.id_abonne = $id_session";
